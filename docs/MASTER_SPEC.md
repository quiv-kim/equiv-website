...
Mobile Typography는 Section Label 6.25px, HOME Hero Title 16.5px, Section Title 10px을 중심으로 Desktop과 명확히 분리된 Corporate Compact Scale을 사용한다. 카드 내부 영문 제목과 서비스 카드 한글·영문 제목은 모두 9px, Body는 9.5~9.75px을 기본 범위로 삼고 넉넉한 행간으로 읽기 흐름을 확보한다. 텍스트가 화면을 지배하지 않도록 여백과 콘텐츠의 균형을 우선한다.
