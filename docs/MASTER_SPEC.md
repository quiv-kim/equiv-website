...
Mobile Typography는 Section Label 8px, Hero Title 17~19px, Section Title 15.5~18px을 중심으로 Desktop과 분리된 Compact Scale을 사용한다. Card Title은 12~16px, Body는 11.5~12px을 기본 범위로 삼고 충분한 행간으로 읽기 흐름을 확보한다. 제목을 크게 보이게 하는 것보다 여백과 절제된 위계로 Premium 인상을 만드는 것을 우선한다.
