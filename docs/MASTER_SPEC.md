...
Mobile Typography는 Section Label 10px, Hero Title 26~30px, Section Title 24~29px을 중심으로 일관된 위계를 사용한다. 제목을 크게 보이게 하는 것보다 충분한 행간과 절제된 크기로 읽기 편한 Premium 인상을 우선한다.
