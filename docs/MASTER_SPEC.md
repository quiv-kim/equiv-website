...
Mobile Typography는 HOME Hero Title 28px, Main Section Title 22px, Detail Page Title 25px을 사용한다. Card Title은 16px, Body와 Button은 14px, Auxiliary Text와 Mobile Navigation은 13px로 통일한다. Form Input은 iOS 자동 확대 방지를 위해 16px을 유지한다. Desktop과 Tablet Scale은 변경하지 않는다.
